...
public class AirHockeyRenderer implements GLSurfaceView.Renderer {
    public static final int POSITION_COMPNENT_COUNT = 2;//2 x y 0 1  4 x y  z w
    public static final int COLOR_COMPNENT_COUNT = 3;// opengl 是本地系统直接运行在硬件上的  如果使用的是java的API那么就需要将java的内存拷贝到c里面（或者使用JNI开发）
    public static final int BYTES_PRE_FLOAT = 4;// 浮点数32位4字节
    public static final int STRIDE = (POSITION_COMPNENT_COUNT + COLOR_COMPNENT_COUNT) * BYTES_PRE_FLOAT;
